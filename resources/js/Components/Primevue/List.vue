<template>
    <div class="bg-surface-50 dark:bg-surface-950 ">
        <div class="bg-surface-0 dark:bg-surface-900 p-6 shadow rounded-border">
            <div class="font-medium text-3xl text-surface-900 dark:text-surface-0 mb-4">Applicant Profile</div>
            <div class="text-surface-500 dark:text-surface-300 mb-6">Egestas sed tempus urna et pharetra pharetra massa massa ultricies.</div>
            <div class="grid grid-cols-12 gap-4 grid-nogutter border-t border-surface ">
                ...
                <div class="col-span-12 p-4">
                    <div class="text-surface-500 dark:text-surface-300 font-medium">Bio</div>
                ...
                <div class="col-span-12 p-4">
                    ...
                    <div class="flex md:items-center md:justify-between border-t border-surface p-2 flex-col md:flex-row">
