...
<template>
    <SimpleCard title="Customers" description="List of customers with advanced filtering capabilities">
        <DataTable v-model:filters="filters" v-model:selection="selectedCustomers" :value="customers" paginator :rows="5" dataKey="id" filterDisplay="menu"
